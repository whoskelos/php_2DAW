...
<body>
    ...
    if (isset($_POST["enviar"])) {
        ...
        if (isset($_POST['valEliminado'])  && $_POST['valEliminado'] != "") {
            $valorAEliminar = $_REQUEST['valEliminado'];
            echo "<h3>Matriz con valor eliminado</h3>";
            echo "<p>Valor a eliminar: $valorAEliminar</p>";
            if (isset($matriz[$valorAEliminar])) {
                unset($matriz[$valorAEliminar]);
                print "<pre>\n";
                print_r($matriz);
                print "</pre>\n";
            }else{
            ...
            echo "<p style:'color:red;'>No ha escrito ningún valor para eliminar</p>";
        }
    }
    ?>
</body>
