...
<body>
    ...
    if (isset($_POST['btnCalcular'])) {
        ...
        if ($peso <= 0 || $altura <= 0) {
            echo "<p style='color:red;'>Los valores introducidos no son válidos</p>";
        }else{
            $altura_mt = $altura / 100;
            $imc = round($peso / pow($altura_mt,2));
    
            echo "<p>Con un peso de<b> $peso kg</b> y una altura de <b> $altura cm </b>, su índice de masa corporal es <b>$imc</b>";
        }
